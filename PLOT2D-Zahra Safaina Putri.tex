...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-001.png}
\begin{eulerprompt}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
>reset;
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-004.png}
\begin{eulerprompt}
>aspect();
>reset; 
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("cos(6x)+sin(2x)",0,2pi):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-007.png}
\begin{eulercomment}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-008.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-009.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>aspect(2); plot2d("2*x^5-25*x+7"): // tanda titik dua(:) memunculkan grafik
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-011.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
>reset; ...
>a:=7.5; plot2d("exp(2*x^2+2*x/a)"):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-012.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-013.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-014.png}
\begin{eulerprompt}
>reset; plot2d("sin(x)","cos(x/7)",xmin=0,xmax=2pi): //memplot dengan xmin=0 dan xmax=2pi 
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-015.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-017.png}
\begin{eulerprompt}
>reset; ... 
>figure(3,3); ...
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-019.png}
\begin{eulerprompt}
>reset; ...
>figure(2,2); ...
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-021.png}
\begin{eulerprompt}
>reset; aspect(3.2); plot2d("cosec(x)",0,2pi,-2.3,2.3,grid=5,xl="x",yl="cosec(x)"):
\end{eulerprompt}
\eulerimg{7}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-022.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-024.png}
\begin{eulerprompt}
>reset; plot2d("cos(x/5)+sin(x)",-2,2,<adaptive,n=2500):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-025.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-027.png}
\begin{eulerprompt}
>reset; plot2d("3*log(x^2)",-1,2):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-029.png}
\begin{eulerprompt}
>reset; plot2d("25*x^5+x/10",>square):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-030.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-031.png}
\begin{eulerprompt}
>plot2d(''integrate("cos(2*x)*exp(x^3)",0,x)'',0,2):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-033.png}
\begin{eulerprompt}
>reset; plot2d("gamma(x)",2,16,yl="y-values",smaller=8,<vertical):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-035.png}
\begin{eulerprompt}
>reset; x=linspace(0,3pi,2500); plot2d(sin(7x),cos(4x)):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-036.png}
\begin{eulerprompt}
>reset; a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-037.png}
\begin{eulerprompt}
>reset; b:=6; expr &= exp(b*x^2)/b; ...
>plot2d(expr,-2,2):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-038.png}
\begin{eulerprompt}
>reset; plot2d(expr,r=1,thickness=2): // plot di sekitar persegi (0,0)
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-039.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-040.png}
\begin{eulerprompt}
>reset; plot2d(&diff(expr,x),>add,style="--",color=green):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-041.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-042.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-043.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-044.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-045.png}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-046.png}
\begin{eulerprompt}
>function f(x,a) := x^2/a+a*x^2-x; // mendefinisikan fungsi
>a=0.3; plot2d("f",0,1;a): // plot dengan a=0.3
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-047.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot dengan a=0.4
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-048.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot dengan a=0.2
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-049.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot dengan 0.1
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-050.png}
\begin{eulerprompt}
>function f(x) := 2*x^3+3*x-x;... // mendefinisikan fungsi f(x)
>plot2d("f",r=2):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-051.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-052.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-053.png}
\begin{eulerprompt}
...
>plot2d(f,1,3):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-054.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-055.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-056.png}
\begin{eulerprompt}
>function f(x) &= 2*x^x;
>plot2d(f,r=2,cx=2,cy=2,color=red,thickness=4);
>plot2d(&diff(f(x),x),>add,color=blue,style=".-."):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-058.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-060.png}
\begin{eulerprompt}
>aspect(2); columnsplot(ones(1,15),grid=0,color=rgb(1,1,linspace(0,1,15))):
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-061.png}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-062.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-063.png}
\begin{eulerprompt}
>aspect(2); plot2d("cos(2x)",0,2pi); plot2d("sin(5x)",color=red,style="-.-",>add):
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-065.png}
\begin{eulerprompt}
>plot2d("cos(3x)",0,2pi); plot2d(4,sin(1),>points,>add): // titik pada (4,sin(1))
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-067.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-069.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("(1-x)^10",0,1,color=blue,thickness=3); // plot fungsi pertama
>for i=1 to 10; plot2d("bin(10,i)*x^i*(1-x)^(10-i)",>add); end;
>insimg;
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-071.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-074.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-076.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-077.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-078.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-079.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-080.png}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-081.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-083.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-084.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-086.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-087.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-088.png}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-090.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-091.png}
\begin{eulercomment}
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-092.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-093.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-094.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-095.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-096.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-097.png}
...
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-098.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-099.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-100.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-101.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-102.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-103.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-104.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-105.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-106.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-107.png}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-108.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-109.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=blue,thickness=4): // add plot of line
\end{eulerprompt}
\eulerimg{13}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-110.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-111.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-112.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-113.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-114.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-115.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-116.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-117.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-118.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-119.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-122.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-123.png}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-124.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-125.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-129.png}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-130.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-131.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-132.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-134.png}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-135.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-136.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-137.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-138.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-139.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-140.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style="..",color=red):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-141.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-142.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-144.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-145.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-146.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-147.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-148.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-149.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-150.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-151.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-153.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-154.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-155.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-156.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-157.png}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-159.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-160.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-161.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-162.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-163.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-164.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=lightblue):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-165.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-166.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-167.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-168.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-169.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-171.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-172.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-173.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-174.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-175.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-177.png}
\begin{eulerprompt}
> 
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-179.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-180.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-181.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-182.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-183.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-184.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-185.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{17}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-186.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-187.png}
\begin{eulerprompt}
>reset; x=5^(2:8); y=x^3-2*x;
>plot2d(x,y,logplot=4):
\end{eulerprompt}
\eulerimg{27}{images/PLOT2D_23030630034_Zahra Safaina Putri_MAT E-188.png}
